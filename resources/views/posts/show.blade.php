...
<body>
    ...
    <section class="bg-gray-50 dark:bg-gray-800">
        <div class="max-w-screen-xl px-4 py-8 mx-auto space-y-12 lg:space-y-20 lg:py-24 lg:px-6">
            ...
            <div class=" text-center lg:col-span-7">
                <h1 class=" mb-4 text-4xl font-extrabold leading-none tracking-tight md:text-5xl xl:text-6xl dark:text-white">{{$post->title}}</h1>
                <p class=" m-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">{{$post->text_post}}</p>
                <div class="space-y-4 sm:flex sm:space-y-0 sm:space-x-4">
                    ...
                    @if (Auth::user()->role==1)
                    <li>
                        <a href="{{route('dashboard.edit',$post->id)}}"  class="inline-flex items-center justify-center w-full px-5 py-3 text-sm font-medium text-center text-green-900 border border-green-200 rounded-lg sm:w-auto hover:bg-green-100 focus:ring-4 focus:ring-green-100 dark:text-white dark:border-green-700 dark:hover:bg-green-700 dark:focus:ring-green-800">Update</a>
                    </li>
                    @endif
